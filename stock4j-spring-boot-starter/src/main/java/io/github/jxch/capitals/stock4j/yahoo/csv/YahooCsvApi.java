package io.github.jxch.capitals.stock4j.yahoo.csv;
...
import io.github.jxch.capitals.stock4j.yahoo.YahooConfig;
import io.github.jxch.capitals.stock4j.yahoo.YahooStockApi;
...
public class YahooCsvApi implements YahooStockApi {
    ...
    public YahooCsvApi(@Qualifier(Stock4jConfig.OK_HTTP_CLIENT) OkHttpClient client,
