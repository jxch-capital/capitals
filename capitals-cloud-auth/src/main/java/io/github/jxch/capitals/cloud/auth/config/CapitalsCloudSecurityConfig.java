package io.github.jxch.capitals.cloud.auth.config;
...
public class CapitalsCloudSecurityConfig {
    ...
    public UserDetailsService userDetailsService(DataSource dataSource, PasswordEncoder passwordEncoder) {
        ...
        if (!manager.userExists(username)) {
            manager.createUser(new User(username, passwordEncoder.encode(password), List.of(new SimpleGrantedAuthority(role))));
        }
        return manager;
    }
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri(redirectUri + "login/oauth2/code/" + clientId)
